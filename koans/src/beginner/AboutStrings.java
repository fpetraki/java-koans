...
public class AboutStrings {
    ...
    @Koan
    public void stringLength() {          //the length of the sequence of characters represented by this object.
    ...
    @Koan
    public void stringTrim() {      //trim() removes white spaces
        assertEquals("".trim(), "");
    ...
    @Koan
    public void stringSubstring() {  //length always endIndex-1
        String str = "I AM a number ONE!";
    ...
    @Koan
    public void extraArgumentsToStringFormatGetIgnored() { //the rest are ignored, should be as many as the %s, note after %s there is space
